...
def calculate_demographic_data(print_data=True):
    ...
    race_count = pd.Series(df['race'].value_counts().tolist())
    ...
    percentage_country = (df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()) * 100
    ...
    df_i50k = df.loc[(df['native-country'] == 'India') & (df['salary'] == '>50K')]
    top_IN_occupation = df_i50k['occupation'].value_counts().index[0]
